<nav class="navbar navbar-default navbar-fixed-top">
    <div class="brand" style="padding: 22px 70px;>
        <a href="index.html"><img src="{{asset('admin/assets/img/logo2.png')}}" alt="Klorofil Logo" class="img-responsive logo" style="width: 71px"></a>
    </div>
