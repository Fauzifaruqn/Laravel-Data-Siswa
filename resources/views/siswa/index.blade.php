                        ...
                        <div class="panel-body">
                            <table class="table table-hover">
                                ...
                                @foreach($data_siswa as $siswa)
                                    <tr>
                                        <td>
                                            <a href="/siswa/{{$siswa->id}}/profile">{{$siswa->nama_depan}}</a>
                                        </td>
                                        <td>
                                            <a href="/siswa/{{$siswa->id}}/profile">{{$siswa->nama_belakang}}</a>
                                        </td>
                                        <td>
                                            {{$siswa->jenis_kelamin}}
                                        </td>
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="form-group {{$errors->has('jenis_kelamin') ? 'has-error' : ''}}">
                            ...
                            <select name="jenis_kelamin" class="form-control" id="exampleFormControlSelect1">
                                <option value="L" {{(old('jenus_kelamin') == 'L') ? 'selected' : ''}}>Laki-Laki</option>
                                <option value="P" {{(old('jenus_kelamin') == 'P') ? 'selected' : ''}}>Perempuan</option>
                            </select>
